...
class MissionManager:
    ...
    def _compute_mais_probabilities(self, delta_v_mps: float) -> dict:
        ...
        return injury.compute_mais_probabilities(self.mission_config, delta_v_mps)
    ...
    def _compute_expected_injury_cost(self, probabilities: dict) -> float:
        ...
        return injury.compute_expected_injury_cost(self.mission_config, probabilities)
    ...
    def _process_collision_injury(
        ...
        """
        return injury.process_collision_injury(self._eval, self.mission_config, impulse_amount, is_character_collision)
    ...
    def _get_robot_z_offset(self) -> Optional[float]:
        ...
        return food._get_robot_z_offset(self.mission_config, self.config)
